...
var smallestPurchase = purchaseLengths.indexOf(Math.min.apply(Math, purchaseLengths));
var sumOfSmallestPurchase = 0;

for (var i = 0; i < allPurchases[smallestPurchase].items.length; i++){
  sumOfSmallestPurchase += allPurchases[smallestPurchase].items[i].price;
}
